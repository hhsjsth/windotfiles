...
# let-env PROMPT_COMMAND = { oh-my-posh prompt init nu --config D:\scoop\apps\oh-my-posh\current\themes\material.omp.json }
...
# def so [] {
#   let confPath = $nu.config-path
#   source $confPath
# }

def update-hold [...name: string] {
  for $n in $name {
    scoop unhold $n
    scoop update $n
    scoop hold $n
...
# source ~/.zoxide.nu
# source C:\Users\gtr\AppData\Roaming\nushell\starshipInit.nu
